...
export function InforCard(props) {
    ...
    return (
        ...
        >
            ...
            <p className="name text-light text-center">{props.title?.slice(0, 10).concat('...') || props.name?.slice(0, 10).concat('...')}</p>
        </Link>
    )
}
    ...
    return (
        ...
        >
            ...
            <p className="star-infor-banner text-light bg-primary ">
                ...
                <p className="m-0 lg-h4 sm-h5">{props.vote_average || props.popularity}</p>
            </p>
